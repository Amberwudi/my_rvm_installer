...
{
  DEFAULT_SOURCES=(qiniu.forqian.cn/blue_dream_tools/my_rvm_installer bitbucket.org/mpapis/rvm github.com/rvm/rvm)
...
fetch_versions()
{
  ...
  case ${_domain} in
    (qiniu.forqian.cn)
      _url="http://${_domain}/${_account}/${_repo}/rvm-tags.txt"
      ;;
    (bitbucket.org)
...
install_release()
{
  ...
  do
    case ${_source} in
      (qiniu.forqian.cn*)
        _url="http://${_source}/${_version}.tar.gz"
        _verify_pgp="http://${_source}/${_version}.tar.gz.asc"
        ;;
      (bitbucket.org*)
...
install_head()
{
  ...
  do
    case ${_source} in
      (qiniu.forqian.cn*)
        _url="http://${_source}/${_branch}.tar.gz"
        ;;
      (bitbucket.org*)
